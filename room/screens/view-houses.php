    ...
    <body id="body-pd" style="background-color:#f6efe5 !important;">
        ...
        <div class="height-100 bg-light mt-3" style="background-color:#f6efe5 !important;">
            ...
            <div class="table-wrapper mt-5"
                style="background: #fff;padding: 20px;box-shadow: 0 1px 1px rgb(0 0 0 / 5%);">

                <div class="header-container d-flex flex-row justify-content-end">

                    <div>
                        <button type="button" class="btn btn-outline-success" data-bs-toggle="modal"
                            data-bs-target="#add_house"><i class="fa fa-plus" aria-hidden="true"></i> New House</button>
                    </div>
    ...
    ?>
        ...
        $(document).ready(function() {
            $(document).on('click', '#updatebutton', function() {
                ...
                var html_code = "<option selected value=" + estate_owner_id + ">" + estate_owner_names +
                    "</option>";
